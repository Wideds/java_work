...
public class MainClass03 {
	public static void main(String[] args) {
		/*
		 *  MacBook 객체를 생성해서 참조값 mac1 이라는 지역 변수에 담아 보세요.
		 *  
		 *  주의!!
		 *  - MacBook 클래스를 절대 수정하지 마세요
		 *  - MainClass03 은 test.main 패키지에 있고
		 *  - Cpu, Memory, HardDisk, MacBook 클래스는 test.main 패키지에 있기 때문에
		 *    4개의 클래스 모두 import 되어야 한다.
		 */
		MacBook book=new MacBook(new Cpu(), new Memory(), new HardDisk()); //1
		...
		MacBook book3=new MacBook(c, m, h); // 2
